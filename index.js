            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message supprimer me concernant') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/king.jpeg'},caption : `        💫 DULLAH MD DELETED INFORMATION💫\n Message from @${msg.key.participant.split('@')[0]}​` , mentions : [msg.key.participant]},)
                                .then( () => {
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by DULLAH-MD .`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ DULLAH-MD connecting in your account...");
            }
                ...
                console.log("------------------/-----");
                console.log("DULLAH-MD by DULLAH MD installing cmds😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + "Successfully installed DULLAH-MD md commands✔️");
                        }
                        catch (e) {

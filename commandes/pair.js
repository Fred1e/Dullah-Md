...
var session = conf.session.replace(/DULLAH-MD V2;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['DULLAH-MD V2', "safari", "1.0.0"],
            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message supprimer me concernant') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `        😈DULLAH-MD  DELETED INFORMATION😈\n Message from @${msg.key.participant.split('@')[0]}​` , mentions : [msg.key.participant]},)
                                .then( () => {
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("------------------/-----");
                console.log("Dullah Md by Mr Dullah installing cmds😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + "Successfully installed Dullah md commands✔️");
                        }
                        catch (e) {
